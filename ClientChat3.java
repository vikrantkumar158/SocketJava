import java.net.*;
import java.io.*;
public class ClientChat3 implements Runnable
{
	int clientport=2003,serverport=3000;
	DatagramSocket ds;
	Thread recThread;
	ClientChat3()throws Exception
	{
		ds=new DatagramSocket(clientport);
		recThread=new Thread(this);
		recThread.start();
		BufferedReader br=new BufferedReader(new InputStreamReader(System.in));
		String data="C "+Integer.toString(clientport)+" ";
		...
		while(true)
		{
			data=br.readLine();
			String temp=data;
			data="C "+Integer.toString(clientport)+" "+data;
